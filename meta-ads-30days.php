...
$meta_description = "Learn Meta Ads & Instagram Ads marketing with real campaigns. 5Trainers Mohali offers practical ad management training for businesses & careers.";
            ...
            <div class="col-lg-7">
                <div class="section-title-area">
                    <h6 data-aos="fade-up" data-aos-duration="500"
                        class="section-subtitle section-subtitle-2 aos-init aos-animate">Meta Ads</h6>
                    <h2 data-aos="fade-up" data-aos-duration="800" class="section-title aos-init aos-animate">Meta Ads
                        Mastery in 30 Day</h2>
                    <p data-aos="fade-up" data-aos-duration="1100" class="aos-init aos-animate">This 30-day course will
                        teach you everything about Meta Ads (Facebook & Instagram Advertising) — from setting up your
                        first ad campaign to advanced targeting, retargeting, and sales funnel strategies. You’ll gain
                        practical, hands-on skills to generate leads, boost sales, and scale campaigns profitably.</p>
                    <p data-aos="fade-up" data-aos-duration="1300" class="aos-init aos-animate">By the end of the
                        course, you’ll confidently create and manage high-converting Meta Ads for any business or
                        client.</p>
                </div>
                <!--/heading div-->
                ...
                <div class="rightsec">
                        ...
                        <div class="course-journey-card-desktop-wrapper">
                            ...
                            <div class="feature-card">
                                <div class="feature-title zen-typo-subtitle-small">
                                    <h6>Meta Ads Certification Prep</h6>
                                </div>
                                <ul class="unordered-list">
                                    <li class="zen-typo-body-small">Prepare for official Meta Blueprint certifications.
                                    </li>
                                </ul>
                    ...
                    <div class="course-journey-card-desktop two">
                        <div class="course-journey-card-desktop-wrapper">
                            ...
                            <div class="feature-card">
                                ...
                                <ul class="unordered-list">
                                    <li class="zen-typo-body-small">Run live ad campaigns during the course.</li>
                                </ul>
                                <div class="ng-star-inserted topbtm">
                                    <div style="border: none; margin-left: -1px; height: 0px; width: 0px;"></div>
                                </div>
                    ...
                    <div class="course-journey-card-desktop three">
                        <div class="course-journey-card-desktop-wrapper">
                            ...
                            <div class="feature-card">
                                <div class="feature-title zen-typo-subtitle-small">
                                    <h6>Live Q&A Sessions</h6>
                                </div>
                                <ul class="unordered-list">
                                    <li class="zen-typo-body-small">Weekly interactive sessions with experts.</li>
                                </ul>
                                <div class="ng-star-inserted topbtm">
                                    <div style="border: none; margin-left: -1px; height: 0px; width: 0px;"></div>
                                </div>
                    ...
                    <div class="course-journey-card-desktop four">
                        <div class="course-journey-card-desktop-wrapper">
                            ...
                            <div class="feature-card">
                                <div class="feature-title zen-typo-subtitle-small">
                                    <h6>Access to Tools</h6>
                                </div>
                                <ul class="unordered-list">
                                    <li class="zen-typo-body-small">Meta Creative Hub, Canva Pro, AdSpy tools.</li>
                                </ul>
                                <div class="ng-star-inserted topbtm">
                                    <div style="border: none; margin-left: -1px; height: 0px; width: 0px;"></div>
                                </div>
                    ...
                    <div class="course-journey-card-desktop five">
                        <div class="course-journey-card-desktop-wrapper">
                            ...
                            <div class="feature-card">
                                ...
                                <ul class="unordered-list">
                                    <li class="zen-typo-body-small">Course recordings, templates, and future updates.
                                    </li>
                                </ul>
                                <div class="ng-star-inserted topbtm">
                                    <div style="border: none; margin-left: -1px; height: 0px; width: 0px;"></div>
                ...
                <div class="whyShould-container">
                    <div class="whyShould-image-box-wrapper">
                        ...
                        <div class="whyShould-image-box-content">
                            ...
                            <p class="whyShould-image-box-description">Master Meta Ads in just 30 days.</p>
                        </div>
                    </div>
                </div>
            </div><!--/col-->
            <div class="col-lg-3">
                <div class="whyShould-container">
                    <div class="whyShould-image-box-wrapper">
                        ...
                        <div class="whyShould-image-box-content">
                            <h3 class="whyShould-image-box-title">Proven Results</h3>
                            <p class="whyShould-image-box-description">Learn strategies used by top advertisers.</p>
                        </div>
                    </div>
                </div>
            </div><!--/col-->
                ...
                <div class="whyShould-container">
                    <div class="whyShould-image-box-wrapper">
                        ...
                        <div class="whyShould-image-box-content">
                            ...
                            <p class="whyShould-image-box-description">Trainers with real-world campaign success.</p>
                        </div>
                    </div>
                </div>
            </div><!--/col-->
                ...
                <div class="whyShould-container">
                    <div class="whyShould-image-box-wrapper">
                        ...
                        <div class="whyShould-image-box-content">
                            ...
                            <p class="whyShould-image-box-description">Covers all ad types, objectives, and optimization
                                methods.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-7 col-lg-6">
                <div class="accordion rpt mt-80">
                    <div class="box active aos-init aos-animate" data-aos="fade-up" data-aos-duration="500">
                        <div class="label">1. What is the objective of the Meta Ads course?</div>
                        <div class="content">
                            The course aims to teach you how to create, manage, and optimize Facebook and Instagram ad
                    ...
                    <div class="box aos-init" data-aos="fade-up" data-aos-duration="700">
                        ...
                        <div class="content">
                            Yes. We start from the basics, so even those with no prior experience can easily follow and
                            learn.
                        </div>
                    </div>
                    <div class="box aos-init" data-aos="fade-up" data-aos-duration="900">
                        <div class="label">3. What topics will be covered?</div>
                    ...
                    <div class="box aos-init" data-aos="fade-up" data-aos-duration="1100">
                        ...
                        <div class="content">
                            Absolutely. You will work on live ad campaigns to understand real-world challenges and
                            strategies.
                        </div>
                    </div>
                    <div class="box aos-init" data-aos="fade-up" data-aos-duration="1300">
                        <div class="label">5. Can I run ads for my own business during the course?</div>
                        <div class="content">
                            Yes. Many students apply their learning to their own business campaigns and get expert
