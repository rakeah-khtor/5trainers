            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="gotowebsite">
                        ...
                        <!--<a href="assets/uploads" >Download Brochure</a>-->
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="intro-details">
                            ...
                            <h2> with AI</h2> -->
                                    <h2>Digital Marketing Training in Mohali</h2>
                                    <h4>Digital Marketing Training in Mohali – Best Institute 100% Placement</h4>
                                </div>
                    ...
                    <div class="row mtm-30">
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <div class="icon">
                                    <img src="assets/image/icon/Industry-skills.png" alt="Icon" class="without-hover">
                                    <img src="assets/image/icon/Industry-skills-white.png" alt="Icon"
                                        class="with-hover">
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="150">
                                <div class="icon">
                                    <img src="assets/image/icon/Flexibility.png" alt="Icon" class="without-hover">
                                    <img src="assets/image/icon/Flexibility-white.png" alt="Icon" class="with-hover">
                                </div>
                                <!--<h4>Flexibility</h4>-->
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                                <div class="icon">
                                    <img src="assets/image/icon/High-demand.png" alt="Icon" class="without-hover">
                                    <img src="assets/image/icon/High-demand-white.png" alt="Icon" class="with-hover">
                                </div>
                                <!--<h4>High demand</h4>-->
                        ...
                        <div class="col-lg-4 col-md-4 col-6">
                            <div class="icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                                <div class="icon">
                                    <img src="assets/image/icon/Placement-support.png" alt="Icon" class="without-hover">
                                    <img src="assets/image/icon/Placement-support-white.png" alt="Icon"
                                        class="with-hover">
                                </div>
