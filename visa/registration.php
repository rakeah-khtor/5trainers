    ...
    <div class="container Registration-Form">
        ...
        <div class="contact-card" data-animate>
            ...
            <form  action="form.php" method="POST">
                ...
                <input type="text" id="interested" name="service"
                    placeholder="IELTS / PTE / Study Visa / PR / Work Permit">
                ...
                <textarea id="message" name="message"
                    placeholder="Briefly describe your education and plans..."></textarea>
