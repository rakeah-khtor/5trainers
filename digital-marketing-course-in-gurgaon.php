                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Master on-page, off-page, technical, and local SEO to drive organic traffic and improve search rankings using live website projects.
                            </p>
                            <!-- <ul>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Learn to build brand presence, create engaging content, execute paid strategies, and analyze performance across Facebook, Instagram, LinkedIn, and YouTube.
                            </p>
                            <!-- <ul>
                                <li>Facebook</li>
                                <li>Instagram</li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Plan, launch, and optimize high-converting paid campaigns on Google and social media with a focus on ROI and conversion tracking.
                            </p>
                            <!-- <ul>
                ...
                <div class="col-md-6 col-lg-4 mt-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Develop a content strategy that attracts, engages, and converts audiences through blogs, videos, social content, and SEO-optimized copy.
                            </p>
                            <!-- <ul>
                                <li>Blogs</li>
                ...
                <div class="col-md-6 col-lg-4 mt-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Design effective email campaigns, build subscriber lists, write compelling copies, and measure performance for lead nurturing and sales.
                            </p>
                            <!-- <ul>
                ...
                <div class="col-md-6 col-lg-4 mt-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                 Learn to use Google Analytics, Data Studio, and cutting-edge AI-powered marketing tools to measure, analyze, and optimize campaign performance.
                            </p>
                            <!-- <ul>
                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="accordion rpt mt-80">
                        <div class="box active">
                            ...
                            <div class="content">
                                Digital marketing is the practice of promoting brands, products, or services through online digital channels such as search engines, social media, email, and websites.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">2. Who can join this course in Gurgaon?
                            </div>
                            <div class="content">
                               The course is open to students, working professionals, entrepreneurs, freelancers, and career changers—anyone eager to build a future in digital marketing.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">3. I am a complete beginner. Is this course suitable?</div>
                            <div class="content">Yes, the course is designed to take you from basic concepts to advanced strategies, making it ideal for beginners.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">4. What is covered in the curriculum?</div>
                            <div class="content">
                               The curriculum includes SEO, Social Media Marketing, Google Ads (PPC), Content Marketing, Email Marketing, Web Analytics, and AI in marketing.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">5. How practical is the training?</div>
                            <div class="content">
                                The training is heavily hands-on. You will work on live projects, real campaigns, and industry-standard tools throughout the program.
                            </div>
                        </div>

                        <div class="box">
                            <div class="label">6. Do you provide a certificate?</div>
                            <div class="content">Yes, you will receive a course completion certificate from 5Trainers, recognized by the industry.
                            </div>
                        </div>

                        <div class="box">
                            <div class="label">7.Do you offer placement support?</div>
                            <div class="content">Yes, we provide full placement assistance, including interview preparation, resume building, and connecting you with our corporate network in Gurgaon.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">8. Why choose 5Trainers in Gurgaon?</div>
                            <div class="content">For our corporate-experienced trainers, 100% practical curriculum, small class sizes, strong placement record, and location-specific industry insights.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">9. What is the duration of the course?</div>
                            <div class="content">We offer flexible duration options, including fast-track and detailed modules. Please contact us for the latest schedule.
                            </div>
                        </div>
                        <div class="box">
                            <div class="label">10. How do I enroll?</div>
                            <div class="content">You can call our Gurgaon center, visit our website, or walk in for a counseling session to complete your enrollment.
                            </div>
                        </div>
                    </div>
                    <!--/accordion-->
